...
export default function Portfolio() {
  return (
    <section className={styles.container}>
      ...
      <p className={styles.container__text}>Aqui estão um pouco mais dos meus trabalhos como calculista e projetista de estruturas em aço. Separei os tipos mais usuais de estruturas no mercado e ressalto que as descrições são simplificadas e as imagens são apenas ilustrativas. Caso tenham alguma dúvida, ou queira saber mais, sinta-se à vontade de entrar em <Link to='/contato'>contato</Link>.</p>
